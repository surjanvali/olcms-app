...
public class OlcmsNicDataWithoutDistCron {

	public static void main(String[] args) throws Exception {
		try {
			
			//String url="http://localhost:8301/apolcmsapi/acceptnic211220221802nic123data0218245586nicdata";
	        String url="https://apolcms.ap.gov.in/apolcmsapi/acceptnic211220221802nic123data0218245586nicdata";
