...
public class FinalOrderCountReportAction extends DispatchAction {
	@Override
		...
		try {
			...
			if (userId == null || roleId == null || userId.equals("") || roleId.equals("")) {
				...
				sql = " select distinct x.reporting_dept_code AS dept_code,d1.description  AS dept_name,'S' as flag,"
						...
						+ " from ecourts_case_finalorder a inner join ecourts_case_data b on(a.cino=b.cino) "
				...
				request.setAttribute("HEADING", "Final Order Count Report");
	...
	public ActionForward viewdata(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			if(roleId!=null) { // GPO
				...
				heading = "Final Order View Report";
			...
			sql = "select b.dept_code,d.description as dept_name,mobile_no,a.cino,order_document_path   "
					+ " from   "
					+ " ecourts_case_finalorder a  inner join ecourts_case_data b on(a.cino=b.cino)  "
					+ " inner join   "
