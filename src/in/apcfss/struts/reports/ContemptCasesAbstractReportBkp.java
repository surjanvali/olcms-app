...
public class ContemptCasesAbstractReportBkp extends DispatchAction {
	@Override
			...
			try {
				if(con!=null) {
					...
					cform.setDynaForm("caseTypesList", DatabasePlugin
							.getSelectBox("select case_short_name,case_full_name from case_type_master where case_short_name='CC' order by sno", con));
