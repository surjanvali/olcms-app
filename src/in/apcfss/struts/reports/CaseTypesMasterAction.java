...
public class CaseTypesMasterAction extends DispatchAction {
	@Override
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			sql = "select * from apolcms.ecourts_mst_casetypes";
			request.setAttribute("HEADING", "Case Type Master Report");
			...
			if (data != null && !data.isEmpty() && data.size() > 0)
				request.setAttribute("CaseMaster", data);
			else
