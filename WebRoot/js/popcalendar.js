...
function ValidateDate(obj,val1){
    
    if(obj.value=="")
    return false;
    
	if (isDate(obj.value,val1)==false){
		dt.focus()
		return false
	}
    return true
    ...
    */
	...
	var	monthName2 =	new	Array("January","February","March","April","May","June","July","August","September","October","November","December")
	...
	function closeCalendar() {
		...
		hideCalendar();
		if (ctlToPlaceValue.value !=	constructDate(dateSelected,monthSelected,yearSelected))
				{
