...
<div class="page-content fade-in-up">
	<html:form method="post" action="/InterimOrderCountReport"
								...
								<tbody>
									...
									<logic:iterate id="map" name="DATA" indexId="i">
										<tr>
											...
											<a href="./InterimOrderCountReport.do?mode=viewdata&deptId=${map.dept_code}&flag=${map.flag}&SHOWPOPUP=SHOWPOPUP"  > 
...
$(document).ready(function() {
	...
	function ShowHODWise(deptId, deptDesc) {
		...
		$(location).attr("href", "./InterimOrderCountReport.do?mode=getDetailsFromSecDept&deptName="+deptDesc+"&deptId="+deptId);
	}
