		...
		<div class="ibox">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label> &nbsp;&nbsp;&nbsp; Case Full Name <bean:message key="mandatory" />
									</label>
									&nbsp;&nbsp;&nbsp;
									<html:text styleId="caseFullName" styleClass="form-control" property="dynaForm(caseFullName)" maxlength="150" />
								</div>
							</div>
						</div>
...
<script type="text/javascript">
	...
	function saveAck() 
	{
		 if ($("#caseFullName").val() == null || $("#caseFullName").val() == "" || $("#caseFullName").val() == "0") {
			alert("Case Full Name Required");
			$("#caseFullName").focus();
			return false;
		} 
		else if (confirm("Do you want to Proceed and save Nature Petition Master(Case Type) details?")) {
