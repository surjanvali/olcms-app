...
<div class="page-content fade-in-up">
	...
	<div class="ibox">
		<div class="ibox-head">
			<div class="ibox-title">Nodal Officer (Legal) Registration</div>
		...
		<div class="ibox-body">
			<html:form method="post" action="/registerNodal">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<html:select styleId="deptId" property="dynaForm(deptId)"
								...
								<logic:notEmpty name="CommonForm" property="dynaForm(deptsList)">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div class="form-group">
										...
										<html:select styleId="employeeId"
											...
											onchange="populateDetails();" style="width:100%;">
											<html:option value="0">---SELECT---</html:option>
											<logic:notEmpty name="CommonForm"
