...
<div class="page-content fade-in-up">
	<html:form method="post" action="/HighCourtCasesListLaw"
			...
			<div class="ibox">
				<div class="ibox-head">
					<div class="ibox-title">List of High Court Cases to be
						Assigned to HOD/Section Officer</div>
				</div>
				<div class="ibox-body">
						...
						<div class="ibox">
							...
							<div class="ibox-body">
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										<div class="form-group">
											<label>Unknown Department / Category</label>
											<html:select styleId="unknownCat"
												property="dynaForm(unknownCat)"
												styleClass="form-control select2Class">
												<html:option value="0">---SELECT---</html:option>
												<html:option value="GoI">GoI</html:option>
												<html:option value="PSU">PSU</html:option>
												<html:option value="Private">Private Cases</html:option>
											</html:select>
										</div>
									</div>
...
function fnAssign2Misc(){
	...
	if($("#unknownCat").val()==null || $("#unknownCat").val()=="" || $("#unknownCat").val()=="0"){
		alert("Select Category.");
		$("#unknownCat").focus();
		return false;
	}
	else{
		$("#mode").val("assign2UnknownCat");
