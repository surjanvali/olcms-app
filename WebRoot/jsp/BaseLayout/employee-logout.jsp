                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages">
                                <!-- <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.html" class="text-success">
                                            <span><img src="assets/images/aplogo.png" alt="" height="36">APCOS</span>
                                        </a>
                                    </h2>
                                ...
                                <div class="account-content">
                                    <div class="text-center m-b-20">
                                        ...
                                        <p class="text-muted font-13 m-t-10"> You are now successfully Logged Out. </p>
                                    </div>
                            ...
                            <div class="row m-t-30">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted">Return to <a href="./Login.do" class="text-primary m-l-5 m-r-5"><b>Log In</b></a></p>
                                </div>
                            </div>
